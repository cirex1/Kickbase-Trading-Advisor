...
/** Gdzie szukać pakietu. Pierwsza pasująca ścieżka wygrywa. */
const CANDIDATES = ['assets/voice/pack.js', '../assets/voice/pack.js', 'voice/pack.js'];
